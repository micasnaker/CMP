<template>
	<view class="box">
		...
		<view style="margin: 20upx;" v-for="(item,index) in data.list" key="index">
			<view style="color: #349cfe;font-size: 30upx;">转账</view>
				<view style="float: right;color: #fff;">{{item.shouyi}}</view>
			<view style="color: #999999;font-size: 28upx;margin-top:30upx">{{'ID:'+item.rel_id}}</view>
			<view style="color: #999999;font-size: 28upx;margin-top:30upx">{{item.created_at}}</view>
		</view>
		</mescroll-uni>
	</view>
</template>

<template>
	<view class="modal-view" @click="confirm" :class="{'modal-show': !hide}" @touchmove.stop.prevent="empty" v-if="pageCloak">
...
.modal-view{
	...
	.modal-content{background: #19243a;width: 80%;border-radius: 6px;overflow: hidden;position: relative;padding-bottom: 50px;-webkit-transform: scale3d(.465, .465, .465); transform: scale3d(.465, .465, .465);transition: all .2s;will-change: auto;}
